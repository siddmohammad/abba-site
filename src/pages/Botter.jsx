...
function WaMock({ mini = false }) {
  const messages = [
    { type: 'user', text: 'Hey, do you have any appointments available for tomorrow?', time: '11:47 PM' },
    { type: 'bot', text: 'Hello! 😊 May I know your name and what service you are looking for?', time: '11:47 PM' },
    { type: 'user', text: 'I am Nadia. I want to book a hair spa', time: '11:48 PM' },
    { type: 'bot', text: 'Hi Nadia, we have slots available from Saturday. What is your preferred time?', time: '11:48 PM' },
  ];
...
export default function Botter() {
  ...
  useMeta({
    ...
    description: 'Off-hours AI agent for any business. Botter replies to every customer on WhatsApp, Facebook & Instagram — 24/7, with natural fluency.',
            ...
            <div className="row g-3 mb-4">
              {[
                ...
                },
                {
                  ...
                  en_body: 'In natural, fluent language. Collects their name, the service they need, and their preferred time. No robotic responses.',
                  bn_body: 'স্বাভাবিক ভাষায়। customer-এর নাম, কী সেবা দরকার, কখন আসতে চান — সব নেয়। Robot-এর মতো না।',
                },
                {
                  num: '03',
              ...
              <Reveal className="bento-large">
                <GlowCard large style={{ height: '100%' }}>
                  <div className="feature-card-title" style={{ fontSize: '1.1rem', marginBottom: '0.4rem' }}>
                    {t('Speaks Natural Language', 'স্বাভাবিক ভাষায় কথা বলে')}
                  </div>
                  <p className="feature-card-body">
                    {t(
                      'Not stiff or robotic. Fluent phrasing that your customers actually use. They won\'t know it\'s a bot.',
                      'Robot-এর মতো না। আসল ভাষা যেটা আপনার customer-রা ব্যবহার করে। তারা বুঝতেই পারবে না এটা bot।'
                    )}
                  </p>
                  <WaMock mini />
                </GlowCard>
            ...
            <div className="row g-3">
              {[
                ...
                },
                {
                  ...
                  en_body: 'Flawless English and multilingual support — including local phrases. Your customers feel like they\'re talking to a real person, not a rigid chatbot.',
                  bn_body: 'নির্ভুল English আর multilingual support — স্থানীয় phrases সহ। আপনার customer মনে করবে একজন মানুষের সাথে কথা বলছে।',
                },
                {
                  icon: '🎓',
                ...
                <Reveal delay={0}>
                  <TiltedCard className="arcade-card h-100 d-flex flex-column">
                    ...
                    <ul className="text-start mt-4 flex-grow-1">
                      ...
                      <li>{t('Multilingual support', 'Multilingual support')}</li>
              ...
              <div className="col-md-6 col-lg-4">
                <Reveal delay={0.1}>
                  <TiltedCard className="arcade-card h-100 d-flex flex-column">
                    ...
                    <p className="price neon-text">
                      $<CountUp from={0} to={160} duration={2} delay={0.3} separator="," />
                      <span className="fs-6"> / month</span>
                    </p>
              ...
              {[
                {
                  ...
                  en_a: "Botter is designed to feel human — natural phrasing, context-aware replies. Most customers won't notice. And if they ask directly, Botter answers honestly and offers to connect them with your team.",
                  bn_a: 'Botter মানুষের মতো কথা বলে — স্বাভাবিক phrasing, প্রসঙ্গ বুঝে reply দেয়। বেশিরভাগ customer বুঝবে না। যদি সরাসরি জিজ্ঞেস করে, Botter সৎভাবে বলে এবং আপনার team-এর সাথে connect করে দেয়।',
                },
                {
